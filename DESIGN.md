...
### D-040 — A style with no grain does not ship the paper
**Status:** accepted, r33. Extends D-026 and point 4 of D-037.
...
| r39 | 2026-08-30 | Lock is the word for the act D-008, D-011 and D-034 call finalize. It runs front and back: the button, the JSON, the routes and `seat.locked`. Finalize was never true, because D-011 makes the commit replaceable until the phase resolves, and a lock is a thing you can open again. Commit and Reveal keep their names. The decision entries above are left as they were written; CONTEXT.md carries the retired word. |
